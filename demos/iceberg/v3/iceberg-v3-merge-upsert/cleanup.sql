-- ============================================================================
-- Iceberg V3 UniForm — Supply Chain Inventory MERGE Sync — Cleanup
-- ============================================================================
...
DROP DELTA TABLE IF EXISTS {{zone_name}}.iceberg_demos.supply_chain_inventory WITH FILES;

-- STEP 3: Remove the per-demo wrapper folder (now empty)
DROP FOLDER 'iceberg-v3-merge-upsert' IF EXISTS IN ZONE {{zone_name}};
