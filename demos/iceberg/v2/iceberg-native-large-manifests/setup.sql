...
-- and manifest file. DeltaForge must traverse the full manifest chain
...
-- DeltaForge parses the latest metadata.json, resolves the manifest list for the
...
USING ICEBERG
LOCATION 'iceberg-native-large-manifests/web_analytics';
