...
DROP EXTERNAL TABLE IF EXISTS {{zone_name}}.iceberg_demos.user_profiles_iceberg WITH FILES;
...
DROP FOLDER 'iceberg-uniform-schema-drop' IF EXISTS IN ZONE {{zone_name}};
