...
DROP EXTERNAL TABLE IF EXISTS {{zone_name}}.iceberg_demos.regional_sales_iceberg WITH FILES;
...
DROP FOLDER 'iceberg-uniform-partitioned' IF EXISTS IN ZONE {{zone_name}};
