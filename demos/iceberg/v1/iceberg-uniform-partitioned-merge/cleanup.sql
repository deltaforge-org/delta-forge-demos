-- ============================================================================
-- Iceberg UniForm Partitioned MERGE (Inventory Sync) — Cleanup
-- ============================================================================
...
DROP DELTA TABLE IF EXISTS {{zone_name}}.iceberg_demos.partitioned_inventory WITH FILES;

-- STEP 3: Remove the per-demo wrapper folder (now empty)
DROP FOLDER 'iceberg-uniform-partitioned-merge' IF EXISTS IN ZONE {{zone_name}};
