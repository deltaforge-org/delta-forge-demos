-- ============================================================================
-- Iceberg UniForm CRUD Lifecycle — Cleanup
-- ============================================================================
...
DROP DELTA TABLE IF EXISTS {{zone_name}}.iceberg_demos.employees WITH FILES;

-- STEP 3: Remove the per-demo wrapper folder (now empty)
DROP FOLDER 'iceberg-uniform-crud-lifecycle' IF EXISTS IN ZONE {{zone_name}};
