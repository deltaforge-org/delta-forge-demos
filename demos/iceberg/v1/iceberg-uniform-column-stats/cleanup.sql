-- ============================================================================
-- Iceberg UniForm Column-Level Statistics — Cleanup
-- ============================================================================
...
DROP DELTA TABLE IF EXISTS {{zone_name}}.iceberg_demos.ad_clicks WITH FILES;

-- STEP 3: Remove the per-demo wrapper folder (now empty)
DROP FOLDER 'iceberg-uniform-column-stats' IF EXISTS IN ZONE {{zone_name}};
