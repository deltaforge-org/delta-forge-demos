-- ============================================================================
-- Iceberg UniForm Basics — Cleanup
-- ============================================================================
...
DROP DELTA TABLE IF EXISTS {{zone_name}}.iceberg_demos.product_catalog WITH FILES;

-- STEP 3: Remove the per-demo wrapper folder (now empty)
DROP FOLDER 'iceberg-uniform-basics' IF EXISTS IN ZONE {{zone_name}};
