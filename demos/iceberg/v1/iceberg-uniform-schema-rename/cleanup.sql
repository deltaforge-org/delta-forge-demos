-- ============================================================================
-- Iceberg UniForm Column Rename (Field-ID Stability) — Cleanup
-- ============================================================================
...
DROP DELTA TABLE IF EXISTS {{zone_name}}.iceberg_demos.financial_transactions WITH FILES;

-- STEP 3: Remove the per-demo wrapper folder (now empty)
DROP FOLDER 'iceberg-uniform-schema-rename' IF EXISTS IN ZONE {{zone_name}};
