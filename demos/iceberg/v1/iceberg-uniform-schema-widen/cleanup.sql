-- ============================================================================
-- Iceberg UniForm Type Widening — Cleanup
-- ============================================================================
...
DROP DELTA TABLE IF EXISTS {{zone_name}}.iceberg_demos.sensor_readings WITH FILES;

-- STEP 3: Remove the per-demo wrapper folder (now empty)
DROP FOLDER 'iceberg-uniform-schema-widen' IF EXISTS IN ZONE {{zone_name}};
