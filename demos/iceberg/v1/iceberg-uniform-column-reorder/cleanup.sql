-- ============================================================================
-- Iceberg UniForm Column Reorder — Cleanup
-- ============================================================================
...
DROP DELTA TABLE IF EXISTS {{zone_name}}.iceberg_demos.patient_records WITH FILES;

-- STEP 3: Remove the per-demo wrapper folder (now empty)
DROP FOLDER 'iceberg-uniform-column-reorder' IF EXISTS IN ZONE {{zone_name}};
