...
-- STEP 4: Iceberg read-back view over the same LOCATION
-- The MERGE operations in queries.sql commit new Delta versions; UniForm
-- updates the iceberg metadata chain on each commit, and queries against
-- this external table read the latest snapshot.
