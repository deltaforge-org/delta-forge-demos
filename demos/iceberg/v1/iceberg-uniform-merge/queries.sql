...
-- ============================================================================
-- order_fulfillment_iceberg is created in setup.sql. Queries below read the
-- post-MERGE state through the Iceberg metadata chain, proving UniForm's
-- shadow metadata reflects each Delta commit.
--
