-- ============================================================================
-- EDI TRADACOMS UK Retail — Cleanup Script
-- ============================================================================
...
DROP EXTERNAL TABLE IF EXISTS {{zone_name}}.edi_demos.tradacoms_messages WITH FILES;
DROP EXTERNAL TABLE IF EXISTS {{zone_name}}.edi_demos.tradacoms_materialized WITH FILES;

-- STEP 2: Drop Schema

-- Remove the per-demo wrapper folder(s) (now empty after table drops)
DROP FOLDER 'edi-tradacoms-uk-retail' IF EXISTS IN ZONE {{zone_name}};
