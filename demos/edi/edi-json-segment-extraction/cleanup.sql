-- ============================================================================
-- EDI JSON Segment Extraction — Cleanup Script
-- ============================================================================
...
DROP EXTERNAL TABLE IF EXISTS {{zone_name}}.edi_demos.json_extraction_messages WITH FILES;

-- STEP 2: Drop Schema

-- Remove the per-demo wrapper folder(s) (now empty after table drops)
DROP FOLDER 'edi-json-segment-extraction' IF EXISTS IN ZONE {{zone_name}};
