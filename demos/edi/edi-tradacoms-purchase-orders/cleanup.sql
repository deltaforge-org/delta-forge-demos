-- ============================================================================
-- EDI TRADACOMS — Purchase Order Line Items — Cleanup Script
-- ============================================================================
...
DROP EXTERNAL TABLE IF EXISTS {{zone_name}}.edi_demos.tradacoms_order_compact WITH FILES;
DROP EXTERNAL TABLE IF EXISTS {{zone_name}}.edi_demos.tradacoms_order_lines WITH FILES;

-- STEP 2: Drop Schema

-- Remove the per-demo wrapper folder(s) (now empty after table drops)
DROP FOLDER 'edi-tradacoms-purchase-orders' IF EXISTS IN ZONE {{zone_name}};
