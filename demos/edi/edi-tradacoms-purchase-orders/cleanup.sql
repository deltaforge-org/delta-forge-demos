...
DROP EXTERNAL TABLE IF EXISTS {{zone_name}}.edi.tradacoms_order_compact WITH FILES;
DROP EXTERNAL TABLE IF EXISTS {{zone_name}}.edi.tradacoms_order_lines WITH FILES;
