-- ============================================================================
-- EDI Supply Chain X12 — Cleanup Script
-- ============================================================================
...
DROP EXTERNAL TABLE IF EXISTS {{zone_name}}.edi_demos.supply_chain_messages WITH FILES;
DROP EXTERNAL TABLE IF EXISTS {{zone_name}}.edi_demos.supply_chain_materialized WITH FILES;

-- STEP 2: Drop Schema

-- Remove the per-demo wrapper folder(s) (now empty after table drops)
DROP FOLDER 'edi-supply-chain-x12' IF EXISTS IN ZONE {{zone_name}};
