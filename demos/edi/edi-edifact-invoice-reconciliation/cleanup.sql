-- ============================================================================
-- EDIFACT Invoice Reconciliation — Cleanup Script
-- ============================================================================
...
DROP EXTERNAL TABLE IF EXISTS {{zone_name}}.edi_demos.commerce_messages WITH FILES;
DROP EXTERNAL TABLE IF EXISTS {{zone_name}}.edi_demos.commerce_materialized WITH FILES;

-- STEP 2: Drop Schema

-- Remove the per-demo wrapper folder(s) (now empty after table drops)
DROP FOLDER 'edi-edifact-invoice-reconciliation' IF EXISTS IN ZONE {{zone_name}};
