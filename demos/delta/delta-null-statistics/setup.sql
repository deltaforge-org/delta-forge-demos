...
CREATE SCHEMA IF NOT EXISTS {{zone_name}}.null_demos
    COMMENT 'NULL statistics and data skipping tutorial demos';


-- ============================================================================
-- TABLE: patient_records — healthcare records with optional fields
-- ============================================================================
CREATE DELTA TABLE IF NOT EXISTS {{zone_name}}.null_demos.patient_records (
    id                    INT,
    patient_id            VARCHAR,
    name                  VARCHAR,
...
GRANT ADMIN ON TABLE {{zone_name}}.null_demos.patient_records TO USER {{current_user}};
...
-- ============================================================================
INSERT INTO {{zone_name}}.null_demos.patient_records VALUES
...
-- ============================================================================
INSERT INTO {{zone_name}}.null_demos.patient_records
SELECT * FROM (VALUES
