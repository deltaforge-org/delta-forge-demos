...
FROM {{zone_name}}.delta_demos.idempotent_sensor_readings
...
LEFT JOIN {{zone_name}}.delta_demos.idempotent_sensor_readings r
...
ASSERT ROW_COUNT = 15
MERGE INTO {{zone_name}}.delta_demos.idempotent_sensor_readings AS target
...
ASSERT ROW_COUNT = 30
SELECT * FROM {{zone_name}}.delta_demos.idempotent_sensor_readings;
...
SELECT value FROM {{zone_name}}.delta_demos.idempotent_sensor_readings
WHERE sensor_id = 'TEMP-01' AND metric = 'pressure';
